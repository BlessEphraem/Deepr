...
panelOpacity := 255 ; semi-transparent (0-255)
showDelay := 200    ; ms (1 second)
autoSaveInterval := 1000 ; ms (1 second)
slideSpeed := 50 ; Smaller is faster
; --- GLOBAL VARIABLES ---
isPanelShown := false
hoverStartTime := 0
mouseIsOverPanel := false
; --- INITIALIZATION ---
global primaryScreenWidth := SysGet(0)
global primaryScreenHeight := SysGet(1)
; ======================================================================================================================
; Create a Gui with RichEdit controls
; ======================================================================================================================
; Initial values -------------------------------------------------------------------------------------------------------
EditW := 400
EditH := primaryScreenHeight - 100
GuiW := 0
GuiH := 0
REW := 0
REH := 0
